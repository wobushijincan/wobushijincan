$(function(){
    ...
    var rotateAngle = 0;  //大楼摆动最大角度
    var rotateChange = 0; //大楼摆动角度增加量
    ...
    function gameFun() {
        ...
        moveFun();
        function moveFun () {
            var newTranslateTop = parseFloat($("#material-frame .material-content").css('transform').split(",")[5]) + 2;
                    ...
                    if (Math.abs($("#material-frame .material-content").offset().left - $("#mansion-frame .mansion-floor").eq(0).offset().left) < $("#material-frame .material-content").width() / 2){
                        ...
                        function moveFun2(){
                            ...
                            if ( -parseFloat($("#mansion-frame .mansion-content").css('transform').split(",")[5]) > $("#material-frame .material-content").height() * 2.5) {
                                mansionTranVal = parseFloat($("#mansion-frame .mansion-content").css('transform').split(",")[5]) + 6;
                                $("#mansion-frame .mansion-content").css({
